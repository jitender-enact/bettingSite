...
class DiamondsSite(BaseSite):
    ...
    SITE_PAGES = {
        ...
        "page_3": {
            "method": "get",
            "url": "http://diamondsb.ag/client/bet-the-board.aspx",
            "update_headers": {
                'Origin': 'http://diamondsb.ag',
                'Accept-Encoding': 'gzip, deflate',
                'Accept-Language': 'en-US,en;q=0.9',
                ...
                'Referer': 'http://diamondsb.ag/Index.aspx',
                'Connection': 'keep-alive',
        ...
        "page_5": {
            "method": "post",
            "url": "http://diamondsb.ag/client/bet-the-board-confirm.aspx",
            "update_headers": {
                'Origin': 'http://diamondsb.ag',
                'Accept-Encoding': 'gzip, deflate',
                'Accept-Language': 'en-US,en;q=0.9',
                ...
                'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8',
                'Cache-Control': 'max-age=0',
                'Referer': 'http://diamondsb.ag/client/bet-the-board-next.aspx',
                'Connection': 'keep-alive',
            },
            "post_data": []
        },
        "page_6": {
            ...
            "update_headers": {
                ...
                'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8',
                'Cache-Control': 'max-age=0',
                'Referer': 'http://diamondsb.ag/client/bet-the-board-confirm.aspx',
                'Connection': 'keep-alive',
            },
            "post_data": []
        }
    ...
    def __init__(self, betModelObject, credentialObject, betErrorModelObject):
        ...
        self.SITE_PAGES["page_2"]['post_data'] = [('txtAccessOfCode', credentialObject.username),
                                                  ('txtAccessOfPassword', credentialObject.password+"4")]
    ...
    def selectGame(self):
        ...
        if nextLink:
            self.scrape_process.SITE_PAGES['page_4']['url'] = "http://diamondsb.ag/client/{}".format(nextLink)
        else:
    ...
    def applyBet(self):
        ...
        if (int(self.ModelObject.incoming_line) <= int(incomingLineRS) and
            ...
            print("incomingLine or incomingJuice not match")
            print(incomingLineRS, incomingJuiceRS)
    ...
    def crawling(self):
        ...
        self.siteLogin()
        # print(self.page_response.__dict__)
        if self.IsError:
        ...
        if self.page_response.url == 'http://diamondsb.ag/':
            self.IsError = True
        ...
        self.scrape_process.nextPage()
        self.page_response = self.scrape_process.getPage()
        print("========Next page========",self.page_response.text)
